<template>
    <div class="mx-4 md:mx-[93px] flex flex-col gap-4 relative overflow-hidden">
        <div class="lg:flex lg:gap-4 lg:justify-center lg:items-stratch">
            ...
            <div class="h-[90%] aspect-[0.74] lg:w-100 mx-auto lg:mx-auto relative flex items-center justify-center">
                <Motion :key="currentImage" :initial="{ opacity: 0, x: direction > 0 ? 100 : -100 }"
                    ...
                    <img :src="imgs[currentImage]" class="w-full h-full rounded-lg object-fit" alt="Poster" />
                </Motion>
            </div>
        ...
        <div class="flex items-center justify-center gap-6 lg:hidden">
            ...
            <div class="flex gap-2">
                <div v-for="(img, idx) in imgs" :key="idx" :class="[
...
function nextImage() {
    direction.value = 1
    currentImage.value = (currentImage.value + 1) % props.imgs.length
}

function prevImage() {
    direction.value = -1
    currentImage.value =
        (currentImage.value - 1 + props.imgs.length) % props.imgs.length
}
</script>
